...
class GetRoleRequestHandlerTest extends AbstractPbjxTest
{
    public function testHandleRequest()
    {
        ...
        $request = GetRoleRequestV1::fromArray([
            'node_ref' => 'acme:role:8695f644-0e7f-11e7-93ae-92361f002671'
        ]);
        ...
        $this->assertSame(
            '8695f644-0e7f-11e7-93ae-92361f002671',
            $responseRole->get('_id')->toString()
        );

        $this->assertSame(
            ['acme:blog:command:*', 'acme:video:command:*'],
            $responseRole->get('allowed')
        );

        $this->assertSame(
            ['acme:blog:command:publish-article'],
            $responseRole->get('denied')
        );
    }
    ...
    {
        $request = GetRoleRequestV1::fromArray([
            'not_node_ref' => 'acme:role:8695f644-0e7f-11e7-93ae-92361f002671'
        ]);
